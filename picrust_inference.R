...
mal_K1_p=read.table(file="/Users/Shansun/Google\ Drive/picrust/ggs/metagenome_perc.txt",sep="\t")
...
miceK_p=read.table(file='/Users/Shansun/Google Drive/picrust/mice/metagenome_perc.txt',sep="\t")
...
#rhizosphere
rhizoK1_p=read.table(file='/Users/Shansun/Google Drive/picrust/rhizo/metagenome_perc.txt',sep="\t")
